...
if __name__ == '__main__':
    ...
    gt_dir = "/mnt/HDD4/yiting/liif_modify/load/celebAHQ/96_bic/"
    test_dirs = [
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_freq/64_bic/new_96/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_glo/64_bic/96/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_res/64_bic/96/",
            ]
    for td in test_dirs:
    ...
    test_dirs = [
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_freq/64_bic/new_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_glo/64_bic/128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_res/64_bic/128/",
            ]
    for td in test_dirs:
        result = psnr_ssim_dir(td, gt_dir)
        print(td, result)
    ...
    test_dirs = [
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_freq/64_bic/new_256/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_glo/64_bic/256/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_res/64_bic/256/",
            ]
    for td in test_dirs:
        result = psnr_ssim_dir(td, gt_dir)
        print(td, result)
    ...
    test_dirs = [
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_freq/64_bic/new_512/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_glo/64_bic/512/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_res/64_bic/512/",
            ]
    for td in test_dirs:
        result = psnr_ssim_dir(td, gt_dir)
        print(td, result)
    ...
    test_dirs = [
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_freq/64_bic/new_1024/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_glo/64_bic/1024/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_ablation_res/64_bic/1024/",
            ]
    for td in test_dirs:
        result = psnr_ssim_dir(td, gt_dir)
        print(td, result)
