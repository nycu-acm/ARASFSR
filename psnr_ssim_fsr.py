...
if __name__ == '__main__':
    ...
    test_dirs = [
            ...
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/12_bic/new34_96/",
    ...
    gt_dir = "/mnt/HDD4/yiting/liif_modify/load/celebAHQ/160_bic/"
    test_dirs = [
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_edsr/16_bic/128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new34_128/",
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/20_bic/new34_160/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new70_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/16_bic/128/"
            ]
    for td in test_dirs:
    ...
    test_dirs = [
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_edsr/32_bic/256/",
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/32_bic/new_256/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/32_bic/256/",
            ]
    for td in test_dirs:
        result = psnr_ssim_dir(td, gt_dir)
        print(td, result)
    ...
    test_dirs = [
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_edsr/32_bic/256/",
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/64_bic/new_512/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/32_bic/256/",
            ]
    for td in test_dirs:
        result = psnr_ssim_dir(td, gt_dir)
    ...
    test_dirs = [
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new_128_helen/",
            "/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/16_bic/new_128_helen/",
            ]
    for td in test_dirs:
        result = psnr_ssim_dir(td, gt_dir)
        print(td, result)
