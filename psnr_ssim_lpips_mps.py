...
def psnr_ssim_lpips_dir(gt_dir, test_dir, lpips_net, gt_csv='', test_csv=''):
    ...
    return psnr_score / len(gt_img_list), ssim_score / len(gt_img_list), lpips_score / len(gt_img_list), mps_score / len(gt_img_list)

if __name__ == '__main__':
    lpips_net = util_of_lpips('vgg')
    
    gt_dir = "/mnt/HDD0/yiting/liif_modify/load/Helen_test_mtcnn/HR/"
    test_dirs = [
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_edsr/16_bic/128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new34_128/",
            #"/mnt/HDD0/yiting/liif_modify/load/Helen_test_mtcnn/swinir_SR/",
            "/mnt/HDD0/yiting/liif_modify/load/Helen_test_mtcnn/new3_SR/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new70_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/16_bic/128/"
            ]
    for td in test_dirs:
        result = psnr_ssim_lpips_dir(td, gt_dir, lpips_net)
        print(td, result)
    """
    gt_dir = "/mnt/HDD0/yiting/liif_modify/load/celebAHQ/96_bic/"
    test_dirs = [
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_edsr/16_bic/128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new34_128/",
            #"/mnt/HDD0/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/12_bic/new2_96/",
            "/mnt/HDD0/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/12_bic/new3_96/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new70_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/16_bic/128/"
            ]
    for td in test_dirs:
    ...
    test_dirs = [
            ...
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new34_128/",
            #"/mnt/HDD0/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new2_128/",
            "/mnt/HDD0/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new3_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new70_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/16_bic/128/"
            ]
    for td in test_dirs:
    ...
    gt_dir = "/mnt/HDD0/yiting/liif_modify/load/celebAHQ/160_bic/"
    test_dirs = [
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_edsr/16_bic/128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new34_128/",
            #"/mnt/HDD0/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/20_bic/new2_160/",
            "/mnt/HDD0/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/20_bic/new3_160/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new70_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/16_bic/128/"
            ]
    for td in test_dirs:
    ...
    test_dirs = [
            ...
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new34_128/",
            #"/mnt/HDD0/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/32_bic/new2_256/",
            "/mnt/HDD0/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/32_bic/new3_256/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_rdn/16_bic/new70_128/",
            #"/mnt/HDD4/yiting/liif_modify/load/celebAHQ_SR_MM/asfsr_swinir/16_bic/128/"
            ]
    for td in test_dirs:
